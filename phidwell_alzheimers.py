...
def plot_alzheimer_dashboard(results, save_path):
    ...
    fig.suptitle("Φ-Dwell Alzheimer's Eigenmode Analysis\n"
    ...
    # ── Panels 1-8: Box plots for each metric ──
    ...
    # ── Panel 9: MMSE correlation scatter ──
    ...
    # ── Panel 10: Per-band self-transition by group ──
    ...
    # ── Panel 11: MMSE correlation table ──
